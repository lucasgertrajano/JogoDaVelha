...
function gameOver(a) {
    var gameOverAlertElement = "<b>Fim de Jogo </b><br><br> Jogador " + span[a].dataset.player.toUpperCase() + ' venceu !!! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>Velha!!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
